...
(function($) {
	...
	$.csv2table={
		version    : '0.02-b-1.6',
		updateMemo : 'csv2table-0.02-b-1.6 (op.labelX=="useChart")?head.slice(1):op.labelX. Added $.csv2table.reset method . Change $.fn.csv2table.wrtTable to $.csv2table.wrtTable',
