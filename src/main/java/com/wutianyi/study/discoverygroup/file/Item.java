...
public class Item
{
    ...
    void addParent(Item parent, int type)
    {
        parents.add(new ItemRelationship(parent, this, type));
    }

    void addChild(Item child, int type)
    {
        children.add(new ItemRelationship(this, child, type));
